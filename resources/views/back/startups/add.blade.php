...
@section('content')
    <div class="admin-card">
        ...
        <div class="admin-card-body">
            <form action="{{route('admin.startups.add')}}" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control admin-form-control" id="name_of_firm" name="name_of_firm" placeholder="Enter firm name" value="{{old('name_of_firm')}}" required>
                        @error('name_of_firm')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control admin-form-control" id="project_name" name="project_name" placeholder="Enter project name" value="{{old('project_name')}}">
                        @error('project_name')
                            <div class="admin-alert admin-alert-error mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control admin-form-control" id="year_of_operation" name="year_of_operation" placeholder="e.g., 2023" value="{{old('year_of_operation')}}" required>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select class="form-control admin-form-control" id="size_of_company" name="size_of_company" required>
                            ...
                            <option value="Less than 10" {{old('size_of_company') == 'Less than 10' ? 'selected' : ''}}>Less than 10</option>
                            <option value="10-50" {{old('size_of_company') == '10-50' ? 'selected' : ''}}>10-50</option>
                            <option value="51 or Above" {{old('size_of_company') == '51 or Above' ? 'selected' : ''}}>51 or Above</option>
                        </select>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control admin-form-control" id="location_of_firm" name="location_of_firm" placeholder="Enter location" value="{{old('location_of_firm')}}" required>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select class="form-control admin-form-control" id="gender_of_entrepreneurs" name="gender_of_entrepreneurs" required>
                            ...
                            <option value="Male" {{old('gender_of_entrepreneurs') == 'Male' ? 'selected' : ''}}>Male</option>
                            <option value="Female" {{old('gender_of_entrepreneurs') == 'Female' ? 'selected' : ''}}>Female</option>
                            <option value="Other" {{old('gender_of_entrepreneurs') == 'Other' ? 'selected' : ''}}>Other</option>
                        </select>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select class="form-control admin-form-control" id="status_of_firm" name="status_of_firm" required>
                            <option value="Active" {{old('status_of_firm') == 'Active' ? 'selected' : ''}}>Active</option>
                            <option value="Inactive" {{old('status_of_firm') == 'Inactive' ? 'selected' : ''}}>Inactive</option>
                            <option value="Closed" {{old('status_of_firm') == 'Closed' ? 'selected' : ''}}>Closed</option>
                        </select>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control admin-form-control" id="sector" name="sector" placeholder="e.g., Technology, Healthcare, Education" value="{{old('sector')}}">
                        @error('sector')
                            <div class="admin-alert admin-alert-error mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-admin-primary">
                        <i class="fas fa-save me-2"></i>Save Startup
                    </button>
                    <a href="{{route('admin.startups.index')}}" class="btn btn-admin-secondary">
